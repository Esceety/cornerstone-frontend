...
export const metadata = {
  ...
  description:
    'Get in touch with Cornerstone Deliverance & Development Ministries. We serve communities in Florida and Georgia.',
};
          ...
          <div className='max-w-6xl mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
              ...
              {content.contactInfo.locations.map((location, index) => (
                <div
                  key={index}
                  className='bg-white rounded-lg shadow-lg p-6 border-t-4 border-purple-600'
                >
              ...
              <div className='bg-white rounded-lg shadow-lg p-6 border-t-4 border-orange-500'>
                ...
                <a
                  ...
                  className='text-gray-700 hover:text-orange-500 text-lg font-semibold'
                >
              ...
              <div className='bg-white rounded-lg shadow-lg p-6 border-t-4 border-teal-500'>
                <div className='flex items-center mb-4'>
                  <svg
                    className='w-8 h-8 text-teal-500 mr-3'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                  >
