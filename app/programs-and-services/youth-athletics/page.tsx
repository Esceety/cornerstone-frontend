...
export const metadata: Metadata = {
  title:
    'Youth Athletics, Enrichment & Intervention | Cornerstone Deliverance Ministries',
  description:
    "Cornerstone Deliverance Ministries provides comprehensive youth athletics and enrichment programs including performing arts, children's academy, and after-school delinquency prevention.",
  keywords:
    'youth athletics, youth enrichment, performing arts, children academy, after school programs, delinquency prevention, youth development, Baltimore youth programs',
  openGraph: {
    title: 'Youth Athletics, Enrichment & Intervention Programs',
    description:
      'Empowering young individuals through athletics, performing arts, and comprehensive youth development programs.',
    type: 'website',
  },
};
...
export default function YouthAthleticsPage() {
  const serviceData = {
    ...
    imageAlt:
      'Youth Athletics, Enrichment and Intervention Programs - Young people participating in sports, arts, and educational activities',
    programList: [
