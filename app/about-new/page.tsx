...
export const metadata = {
  ...
  description:
    'Learn about Cornerstone Deliverance & Development Ministries, our mission, purpose, and the dedicated team serving the community.',
};
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                ...
                empowerment, and spiritual development. Expand from Florida into
                Georgia and beyond—providing affordable, dignified housing and
