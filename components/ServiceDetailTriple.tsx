...
interface ServiceDetailTripleProps {
  mainTitle: string;
  sections: [ServiceSection, ServiceSection, ServiceSection];
}

export default function ServiceDetailTriple({
  mainTitle,
  sections,
}: ServiceDetailTripleProps) {
  return (
